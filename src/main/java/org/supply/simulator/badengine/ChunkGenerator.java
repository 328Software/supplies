...
//                Positions pos = createSingleQuadPositions("Ground1", op_topLeftX+i*op_quad_size, op_topLeftY-j*op_quad_size, op_quad_size);
                String textureKey = getRandomGroundTextureKey();
                float[] stInfo = getSTInfo(textureKey);
                float[] value = getQuadFloatArrayComplex(op_topLeftX+i*op_quad_size, op_topLeftY-j*op_quad_size, 0f,1f, //X,Y,Z,W
                        1f,1f,1f,1f, //R,G,B,A
...
//                float colorbyte = (((i/op_col%2|j/op_row%2)==0||(i/op_col%2&j/op_row%2)==1)?(blackInt&0xf):(blackInt&0xff));
    ...
    private static float[] getSTInfo(String key) {
        ...
        switch (key) {
            case "Ground1":
                out= new float[]{0.0f/127f, 0f/127f, 63f/127f, 63f/127f};
                break;
            case "Ground2":
                out = new float[]{0f/127f, 64f/127f, 127f/127f, 63f/127f};
                break;
            case "Ground3":
                out = new float[]{0f/127f, 64f/127f, 63f/127f, 127f/127f};
                break;
            case "Ground4":
                out = new float[]{64f/127f, 64f/127f, 127f/127f, 127f/127f};
                break;
        }
        return out;
    }

    private static String getRandomGroundTextureKey() {
        String out = "";
