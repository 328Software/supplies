...
public class FactoryUtils {
    ...
    public static Positions newTexturedColorPositions(String textureKey, float topLeftX, float topLeftY, float topLeftZ, float length, float width) {
        ...
        Vertex v2 = positions.getVertex(2);
        Vertex v3 = positions.getVertex(3);
        v0.setXYZ( topLeftX,       topLeftY,        topLeftZ); v0.setRGB(0.01f, 0.01f, 0.01f); v0.setST(0, 0);
        v1.setXYZ( topLeftX,       topLeftY-length, topLeftZ); v1.setRGB(0.01f, 0.01f, 0.01f); v1.setST(0, 1);
        v2.setXYZ( topLeftX+width, topLeftY-length, topLeftZ); v2.setRGB(0.01f, 0.01f, 0.01f); v2.setST(1, 1);
        v3.setXYZ( topLeftX+width, topLeftY,        topLeftZ); v3.setRGB(0.01f, 0.01f, 0.01f); v3.setST(1, 0);
